            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._cache[key] = cached;
                        if (!(this._transport != null)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._transport.flushAsync(this._cache)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        if (!(this._store != null)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this._store.saveAsync(key, cached)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
