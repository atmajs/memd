...
var TransportWorker = /** @class */ (function () {
    ...
    TransportWorker.prototype.flushAsync = function (force) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    TransportWorker.prototype.getCollection = function () {
        return this.cache.getCollection();
    };
    TransportWorker.prototype.flushInner = function () {
        var coll = this.cache.getCollection();
...
var Cache = /** @class */ (function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, ((_a = this._transport) === null || _a === void 0 ? void 0 : _a.flushAsync())];
                    case 3:
                        _e.sent();
    ...
    Cache.prototype.setRestored = function (coll) {
        var _a;
        this._cache = __assign(__assign({}, ((coll !== null && coll !== void 0 ? coll : {}))), (_a = this._cache, (_a !== null && _a !== void 0 ? _a : {})));
    };
    ...
    Cache.prototype.flushAsync = function (force) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, ((_a = this._transport) === null || _a === void 0 ? void 0 : _a.flushAsync(force))];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
