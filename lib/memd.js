...
var Cache = /** @class */ (function () {
    ...
    Cache.prototype.resolveKey = function () {
        ...
        var key = (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.keyResolver) === null || _b === void 0 ? void 0 : _b.call.apply(_b, __spreadArrays([_a], args));
...
function fn_memoize(fn, opts, key) {
    ...
    var Wrapper = function () {
        ...
        var isPromise = null;
        var val = fn.apply(_thisArg !== null && _thisArg !== void 0 ? _thisArg : this, args);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        isPromise = null;
                        val = fn.apply(_thisArg !== null && _thisArg !== void 0 ? _thisArg : this, args);
                        if (_clearOnReject === true) {
                            isPromise = val != null && typeof val === 'object' && typeof val.then === 'function';
                            if (isPromise) {
                                val = val.then(null, function (err) {
...
function fn_clearMemoized(fn) {
    ...
    (_d = (_c = fn) === null || _c === void 0 ? void 0 : _c.clearArgs) === null || _d === void 0 ? void 0 : _d.call.apply(_d, __spreadArrays([_c], args));
    return;
}
